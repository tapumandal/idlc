...
--
-- Host: localhost
-- Generation Time: Jul 27, 2018 at 08:14 AM
...
INSERT INTO `tbl_ifa_registrations` (`ifa_reg_id`, `application_no`, `application_status`, `user_name`, `password`, `first_name`, `middle_name`, `last_name`, `mobile_no`, `email`, `father_name`, `mother_name`, `nationality`, `date_of_birth`, `national_id_card_no`, `image_ext`, `pre_addr_flat_no`, `pre_addr_house_no`, `pre_addr_road_no`, `pre_addr_division_id`, `pre_addr_district_id`, `pre_addr_ps_id`, `pre_addr_premise_ownership`, `per_addr_flat_no`, `per_addr_house_no`, `per_addr_road_no`, `per_addr_division_id`, `per_addr_district_id`, `per_addr_ps_id`, `per_addr_premise_ownership`, `latest_degree`, `last_educational_institution`, `is_job_holder`, `organization_name`, `employee_id_no`, `designation`, `job_holder_department`, `is_student`, `institution_name`, `student_id_card_no`, `receive_sales_commission_by`, `bank_id`, `bank_branch_id`, `bank_account_no`, `bKash_acc_type`, `bKash_mobile_no`, `training_status`, `student_department`, `is_same_as_present_address`, `others_nationality`, `others_user_type`, `user_type_id`) VALUES
(0, 1, 'partially_completed', 'gfgf1', '$2y$10$8jUqI2d2Yg0ohpvozAjSU.b6YhP85Uk8V0U3Qvav3NRK.x2I.HcQy', 'gfgf', 'fgfg', 'fgfg', 123456789, 'kamruljpi@gmail.com', 'kamrujdhf', 'hkjdhgk', '4', '1970-10-22', '123456789', '', NULL, NULL, NULL, 0, 0, NULL, '0', NULL, NULL, NULL, 0, 0, NULL, '0', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 'Bank', 4, 11, '454545454', 'Agent', NULL, 'Fail', NULL, 0, NULL, NULL, 0),
(0, 2, 'partially_completed', 'name2', '$2y$10$lVrviGtl./ujrCjdxIvRpe537bjvQJbjEj55nzrB0cIEQHX5dUpx6', 'NAME', 'middle', 'last', 234232423, 'tapu@gmail.com', 'fname', 'mname', '-1', '0000-00-00', '1221122112', '', NULL, NULL, NULL, 0, 0, NULL, '0', NULL, NULL, NULL, 0, 0, NULL, '0', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 'Bank', NULL, NULL, NULL, 'Agent', NULL, 'Fail', NULL, 0, 'KolomboChanged', 'Others', -1),
(0, 3, 'partially_completed', 'fhgfjj3', '$2y$10$x0rX9sj/1.0CcRN7xFyO4u7gX/f3WHsO7aLFjYdIs1.E7MXJD1C3e', 'fhgfjj', 'fdfdf', 'cxcxc', 123456788, 'fdgfhj@fghj.dfgh', 'dfghjk', 'dfghjk', '-1', '1999-07-01', '1234567890', '', '546ghbn', 'dfgh56', '23456', 1, 3, 'sdfghjjkm', '2', 'cvbnm', 'sdfvbnm', 'sdfcgvbn', 1, 3, 'dfghjk', '2', 'dfghjm', 'dfghjkl', 0, 'fdfd', '232424', 'dfdgd', 'dfgd', 0, 'sdfsdf', '433434', 'Bank', 4, 11, '1234567890', 'Agent', NULL, 'Fail', 'sdfsfds', 0, 'sdfghjk', NULL, 2);
...
(1, 0, 'Premise Ownership', 1, 1, 'deleted', '2018-07-21 02:50:54', '2018-07-21 02:57:23'),
(2, 0, 'Premise Ownerships', 0, 1, 'update', '2018-07-21 02:58:06', '2018-07-21 02:58:46');
...
ALTER TABLE `tbl_ifa_registrations`
  ADD PRIMARY KEY (`application_no`,`ifa_reg_id`),
  ADD UNIQUE KEY `mobile_no_UNIQUE` (`mobile_no`),
  ADD UNIQUE KEY `email_UNIQUE` (`email`),
  ADD UNIQUE KEY `national_id_card_no_UNIQUE` (`national_id_card_no`);
...
--
ALTER TABLE `mxp_menu`
  MODIFY `menu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
...
--
ALTER TABLE `tbl_premise_ownership`
  MODIFY `id_premise_ownership` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
